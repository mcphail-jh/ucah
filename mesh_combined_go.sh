...
###################################################################
csv_file="Info_Case_el_aoa.csv" # name of your CSV file
csv_mesh_folder="lhs_elevator_mesh"       # mesh file
base_journal="symJournalFVD.jou" # template journal file
base_dir="/scratch/qvu2hx/case"  # main directory for all cases
case_folder="elevator_aoa_cases" # folder where current cases are running
###################################################################
...
# rm_char script
for f in /scratch/qvu2hx/case/${results_folder}/Case_*/Ca*.jou; do
