...
data_path = "tests/optimization_tests/2d_test/data.csv"
param_num = 2
objective_name = "obj_func"
output_path = "tests/optimization_tests/2d_test/sm.pkl"
GenerateSM(data_path, param_num, objective_name, output_path)

# Setting up optimizer
opt = KrigOpt(ObjFuncSM="tests/optimization_tests/2d_test/sm.pkl", _debug=False)

print(eval_SM_value(opt.ObjFuncSM, np.array([[2, 1]])))
